...
if SERVER then
	...
	function ENT:TracksCreate( PObj )
		...
		local LeftTracksArmor = self:AddArmor( Vector(40,41,44), Angle(0,0,0), Vector(-115,-15,-45), Vector(35,15,0), 200, self.FrontArmor )
		...
		local RightTracksArmor = self:AddArmor( Vector(40,-41,44), Angle(0,0,0), Vector(-115,-15,-45), Vector(35,15,0), 200, self.FrontArmor )
	...
	ENT.TrackScrollTexture = "materials/vehicles/LightTankTreadCol"
