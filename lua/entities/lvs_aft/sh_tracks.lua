...
if SERVER then
	...
	function ENT:TracksCreate( PObj )
		...
		local LeftTracksArmor = self:AddArmor( Vector(50,41,44), Angle(0,0,0), Vector(-110,-15,-40), Vector(30,15,0), 200, self.FrontArmor )
		...
		local RightTracksArmor = self:AddArmor( Vector(50,-41,44), Angle(0,0,0), Vector(-110,-15,-40), Vector(30,15,0), 200, self.FrontArmor )
	...
	ENT.TrackScrollTexture = "materials/vehicles/aft/RelicTread"
